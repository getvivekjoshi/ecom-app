...
const navigate = useNavigate()
  ...
  const handleSubmit = (event) => {
    ...
    if (event.currentTarget.checkValidity() === true && email && password) {
      ...
      .catch((er) =>  setLoginUserResponseSteate({ error: er.response.data.message ? er.response.data.message : er.response.data }))
    }
        ...
        <Col md={6}>
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Button variant="primary" type="submit">
              {loginUserResponseSteate && loginUserResponseSteate.loading === true ? (
                <Spinner
                as="span"
                animation="border"
                size="sm"
            ...
            <Alert show={loginUserResponseSteate && loginUserResponseSteate.error === 'Wrong credentials'} variant="danger">
                Wrong credentials
            </Alert>
          </Form>
        </Col>
